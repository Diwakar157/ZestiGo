...
function RestaurantDetails() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
      ...
      <div className="relative w-full overflow-hidden rounded-[24px] h-[180px] sm:h-[220px] md:h-[320px] shadow-soft">
        <img
      ...
      <div className="mt-6 rounded-3xl bg-card p-6 shadow-card sm:p-8 border border-border">
