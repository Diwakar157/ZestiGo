...
public class OrderItem {
    ...
    public OrderItem(String id, Order order, FoodItem foodItem, Integer quantity, BigDecimal priceAtPurchase) {
        this.id = id;
        this.order = order;
    ...
    public static class OrderItemBuilder {
        ...
        public OrderItemBuilder id(String id) { this.id = id; return this; }
        public OrderItemBuilder order(Order order) { this.order = order; return this; }
        public OrderItemBuilder foodItem(FoodItem foodItem) { this.foodItem = foodItem; return this; }
